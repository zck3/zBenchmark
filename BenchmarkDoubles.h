...
#define MAX_DOUBLE_OPS (128LU * ONE_MEGABYTE)

// Lower is better

class BenchmarkDoubles : public Benchmark
{
public:
	float measure ();

	const char *name () {
		return "Floating Point 64-bit";
	}

	float referenceMeasurement () {
		return REFERENCE_SYSTEM_64BIT_DOUBLES_PERFORMANCE;
	}
};
